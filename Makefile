...
# CFLAGS / LDFLAGS
PKGS      = wlroots wayland-server xkbcommon libinput xcb-icccm $(XLIBS)
...
install: dwl
	...
	cp -f dwl-getwindowtitle $(DESTDIR)$(PREFIX)/bin
	chmod 755 $(DESTDIR)$(PREFIX)/bin/dwl-getwindowtitle
